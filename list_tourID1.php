...
//$prods = Tour::list_tour();


// $prods là biến khởi tạo đối tượng từ class Tour, function list_tour()
if (!isset($_GET["maphuongtien"])){
    $tours = Tour::list_tourID1();
}
else{
        ...
        <ul class = "list-group">
            ...
            <?php
                foreach($phuongtiens as $item) {
                    echo "<li class = 'list-group-item'><a href=/Index.php?maphuongtien=".$item["MaPhuongTien"].">".$item["TenPhuongTien"]."</a></li>" ;
                }?>
        </ul>
        </div>
