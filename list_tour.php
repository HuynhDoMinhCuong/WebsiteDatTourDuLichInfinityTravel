...
<header class="bg-primary text-white py-3">
    ...
    <div class="col-sm-3">
        <h2> Phương tiện </h2>
        <ul class = "list-group">
                    <a href="list_tour.php" class="list-group-item">Tất cả</a>     
            <?php
                foreach($phuongtiens as $item) {
                    echo "<li class = 'list-group-item'><a href=/list_tour.php?phuongtienID=".$item["MaPhuongTien"].">".$item["TenPhuongTien"]."</a></li>" ;
                }?>
        </ul>
        </div>
    </div>  
        ...
        <div class="col-sm-12">
            ...
            <table border="1" class="table">
                <tr>
                    ...
                    <td class="col-md-2"><b><center>Giá tour</center></b></td>
                    <td><b><center>SL vé hiện có</center></b></td>
                ...
                ?>
                <tr> 
                    <td><center><?php echo $item['MaTour']?></center></td>
                    <td><center><?php echo $item['MaPhuongTien']?></center></td>
                    
                    

                    <td><?php echo $item['TenTour']?></td>
                    <td><center><?php echo $item['NoiKhoiHanh']?></center></td>
                    <td><center>
                        <?php $date=date_create($item['NgayKhoiHanh']);
                        echo date_format($date,"d/m/Y")                                        // echo date_format($date,"d/m/Y H:i:s")
                        ?></center></td>  
                    <td><center><?php echo $item['ThoiGian']?></center></td>
                    <td><?php 
                            $giaTour = $item['GiaTour'];
                            $formattedPrice = number_format($giaTour);
                            printf(" %s VND\n", $formattedPrice) ; 
                        ?></td>
                    <td><center><?php echo $item['SoLuongVeHienCo']?></center></td>
                    <td><?php echo $item['MoTa']?></td>
                    <td><center><img src="<?php echo $item['Hinh']; ?>" class="img-responsive" style="width: 100%" alt='Image' onerror="this.src='uploads/<?php echo $item['Hinh']; ?>'"><center></td>
                   <!-- <td><p><?php echo $item['Hinh']?></p></td> -->
                   
                   
                   <?php  echo "<td><a href='update_tour.php?id=" .$item['MaTour'] ."' class='text-primary'>Sửa</a></td>";
                          echo "<td><a href='delete_tour.php?id=" .$item['MaTour'] ."' class='text-danger'>Xoá</a></td> ";
